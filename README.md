...
```sh
bun add @solid-gpui/solid solid-js@2.0.0-rc.4   # or: npm i …
...
Targets Solid `2.0.0-rc.4` with the matching `@solidjs/universal`,
...
- Solid `2.0.0-rc.4` is itself a prerelease; keep runtime/universal/compiler
  versions aligned.
