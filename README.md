...
```sh
bun add @solid-gpui/solid solid-js@2.0.0-rc.7   # or: npm i …
bun add -d @solidjs/babel-plugin@2.0.0-rc.7 @babel/core
```
...
Targets Solid `2.0.0-rc.7` with the matching `@solidjs/universal`,
...
- Solid `2.0.0-rc.7` is itself a prerelease; keep runtime/universal/compiler
  versions aligned.
